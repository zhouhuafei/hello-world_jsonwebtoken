...
const token = jwt.sign({username: '1123486116@qq.com'}, secret, {expiresIn: expiresIn}); // expiresIn过期时间。单位为：秒。
...
redisClient.on('connect', function () {
    ...
    redisClient.set(token, JSON.stringify({username: '1123486116@qq.com'}), 'ex', expiresIn);
